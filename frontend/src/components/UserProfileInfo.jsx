      ...
      <div className="flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="w-full pt-6 md:pt-0 md:pl-36">
          <div className="flex flex-col md:flex-row items-start justify-between">
            ...
            {/* if user is not a profile that means he is opening his profile so we will give edit button */}
            {!profileId && (
              <button
          ...
          <div className="flex item-center gap-6 mt-6 border-t border-gray-200 pt-4">
            <div>
