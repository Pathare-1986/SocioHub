          ...
          <form className="space-y-4" onSubmit={handleSaveProfile}>
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    className="w-40 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2"
                    src={
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-hover-50 transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-6 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer"
              >
                Save Chnages
              </button>
            </div>
